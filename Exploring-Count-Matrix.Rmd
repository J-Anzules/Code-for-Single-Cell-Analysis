...
HQ_counts <- read.csv("/Documents and Settings/jonan/Documents/1Work/scWork/hpap.pmacs-BetaCells/Data/FirstCountMatrix.csv", row.names = 1)
...
# TODO Need to set up a look for plots
plot_hvg +
...
metadata_df <- read.csv("/Documents and Settings/jonan/Documents/1Work/scWork/hpap.pmacs-BetaCells/Data/PANCDB/Cleaned-N-Aligned-hpapdata/metadata_T2D.csv")
...
sce_pancreas <- slingshot(sce_pancreas, clusterLabels = "seurat_clusters", reducedDim = "UMAP")
