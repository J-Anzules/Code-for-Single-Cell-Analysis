...
str(txi_read)
```
```{r - EnsembleID needs to be changed to gene symbols}
...
ensembl_ids <- rownames(txi_read$counts)  # Replace with your actual row names

# Retrieve the corresponding gene symbols
...
txi_read$counts_rownames <- gene_info$external_gene_name[match(ensembl_ids, gene_info$ensembl_gene_id)]

# Identify mitochondrial genes
mito_genes <- grep("^MT-", txi_read$counts_rownames, value = TRUE)
