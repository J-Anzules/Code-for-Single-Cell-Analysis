...
percent.mt <- Matrix::colSums(GetAssayData(seurat_object, assay = "RNA", slot = "counts")[mitochondrial_genes, ]) / Matrix::colSums(GetAssayData(seurat_object, assay = "RNA", slot = "counts")) * 100
seurat_object[["percent.mt"]] <- CreateAssayObject(counts = matrix(percent.mt))
# Assuming percent.mt is a vector with length equal to the number of cells in seurat_object
# and its names correspond to the cell names in seurat_object
